...
A script, plugin or mod inside the container can use these to send metrics to COSY's internal API. For a working example, see the [COSY Minecraft Integration Mod](https://github.com/Magenta-Mause/Cosy-Minecraft-Integration-Mod).
