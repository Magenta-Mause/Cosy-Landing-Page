...
Values can be numbers (integers or decimals). The keys and values are stored alongside the standard metrics and displayed in the dashboard.
...
Custom metrics appear alongside standard metrics in the [Dashboard](/docs/features/dashboard) and Metrics page. They are stored in InfluxDB and support the same time-range queries as built-in metrics.
