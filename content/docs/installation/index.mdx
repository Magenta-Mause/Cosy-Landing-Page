...
> **Note:** COSY currently only supports **HTTP**. HTTPS support will be available in a future release. If you need HTTPS now, you can place a reverse proxy (e.g., nginx, Caddy) in front of COSY to handle TLS termination.
