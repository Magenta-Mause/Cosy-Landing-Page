...
COSY provides pre-configured templates for popular games like Minecraft, ARK: Survival Evolved, and more. Select a template to auto-fill all configurations.
...
<Cards>
  <Card
    ...
    href="/docs/getting-started/docker-abstraction"
